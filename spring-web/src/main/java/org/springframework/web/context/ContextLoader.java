...
/**
 * ContextLoader：为根应用程序上下文执行实际的初始化工作。由{@link ContextLoaderListener}调用。
 */
public class ContextLoader {


	//根WebApplicationContext的id，作为在IOC中唯一标识
	 ...
	 * 使用构建时提供的应用程序上下文，或者根据上下文-params“{@link #CONTEXT_CLASS_PARAM contextClass}”和“{@link #CONFIG_LOCATION_PARAM contextConfigLocation}”创建一个新的上下文。
	 *
	 * @see #ContextLoader(WebApplicationContext)
	 * @see #CONTEXT_CLASS_PARAM
	 * @see #CONFIG_LOCATION_PARAM
	 */
	//initWebApplicationContext()方法即为初始化context的核心代码
